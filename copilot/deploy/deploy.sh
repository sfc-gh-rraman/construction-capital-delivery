#!/bin/bash
# =============================================================================
# ATLAS Capital Delivery - SPCS Deployment Script
# =============================================================================
# This script builds and deploys the ATLAS application to Snowpark Container Services
#
# Usage:
...
SCHEMA="SPCS"
IMAGE_REPO="ATLAS_IMAGES"
COMPUTE_POOL="ATLAS_COMPUTE_POOL"
...
get_status() {
    ...
    echo ""
    log_success "ATLAS endpoint URL: $ENDPOINT_URL"
}

# View service logs
view_logs() {
    log_info "Fetching service logs..."
    snow sql -c $CONNECTION -q "CALL SYSTEM\$GET_SERVICE_LOGS('$DATABASE.$SCHEMA.$SERVICE_NAME', 0, 'atlas', 100)"
}
